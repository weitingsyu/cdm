...
public class Program {
  ...
  public static void main(final String[] args) throws ExecutionException, InterruptedException {
    ...
    final AdlsAdapter adlsAdapter = new AdlsAdapter(
        "ssotstorage.dfs.core.windows.net", // Hostname.
        "/powerbi", // Root.
        "ad8dc70a-f3e0-46b6-8d5a-f855e329dbde",  // Tenant ID.
        "5da00db2-335a-4873-816c-9b6314d453c6",  // Client ID.
        "TnMD@?s@Hn5Ze=Qsd5p0xI1.Ui@jfh?s" // Client secret.
